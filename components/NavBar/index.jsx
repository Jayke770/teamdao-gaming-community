...
export default function Navbar({ }) {
    return (
        <div className="translucent flex w-full fixed z-20 top-0 left-0 bg-bgn min-h-[60px] px-4 border-b border-primary/60">
            ...
            <div className='h-screen w-screen hidden fixed justify-end top-0 right-0 md:[position:_unset] md:bg-transparent md:h-auto md:flex md:items-center md:flex-row md:ml-4 md:w-full'>
                <div className='w-96 md:w-full bg-bgn border-l-[0.1px] border-l-primary md:border-l-0 md:bg-transparent flex flex-col py-10 px-5 md:px-0 md:py-0 md:flex-row md:justify-between'>
