...
export default function CreateYourOwnTournament() {
    return (
        <div className="px-6 py-8">
            <div className="relative bg-gradient-to-r from-primary/10 to-slate-900 flex flex-col gap-3 border border-slate-800 p-10 rounded-md lg:pr-96 transition-all overflow-hidden">
